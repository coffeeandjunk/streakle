Router.configure({
    ...
    waitOn: function() {
        return [Meteor.subscribe('images'), Meteor.subscribe('posts'), Meteor.subscribe("rooms"), Meteor.subscribe("messages"), Meteor.subscribe("users"), Meteor.subscribe('tags'), Meteor.subscribe('notifications')];
    }
});
